...
The objective was to design a reliable 140 Mbit/s digital transmission system while ensuring:
- Full ITU-R performance compliance
- Adequate fade margin and availability
- Optimized infrastructure deployment
- Long-term financial sustainability (25-year horizon)
...
- Topology: Cabo Raso – Serra de Sintra – Alcochete
- Architecture: Multi-hop microwave link with active repeater
- Antennas: 1 m and 4.5 m parabolic reflectors
...
The project includes:
  ...
  - CAPEX (antennas, transmitters, towers, repeaters)
  - OPEX (maintenance, spectrum leasing via ANACOM)
  - Break-even analysis
